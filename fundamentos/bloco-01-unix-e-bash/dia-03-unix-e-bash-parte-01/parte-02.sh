...
#Exercicio 1
echo -e "\nMovendo para o diretorio unix_tests"
cd unix_tests
...
#Exercicio 2
echo -e "\nMostrando o arquivo countries.txt"
cat countries.txt 
sleep $delay
...
#Exercicio 7
echo -e "\nBuscando frases que não tenham a palavra fox"
grep -v fox phrases.txt
sleep $delay

#Exercício 8
echo -e "\nContando o numero de palavras do arquivo phrases"
echo -e "Total de palavras: $(wc -w phrases.txt)"
sleep $delay

#Exercício 9
echo -e "\nContando o numero de linhas do arquivo phrases"
echo -e "Total de linhas: $(wc -l phrases.txt)"
sleep $delay
