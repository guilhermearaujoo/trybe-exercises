...
function howManyTimes(array) {
  ...
  // verifica a quantidade de vezes que aperece e cria objeto
  
  for (let index of arrayUnico) {
    let contador = 0;
    for (let i of array) {
      if (index === i) {
        contador += 1;
    ...
    objeto[index] = contador;
  }

  return objeto;
}

console.log(howManyTimes(basket));